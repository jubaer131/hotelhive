    ...
    return (
        <section>
            <div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 md:px-24 xl:px-48 mt-12">
                <h1 className="text-5xl font-bold leading-none text-center">Get Our Updates</h1>
            ...
            <div className="w-full h-[400px] bg-[url('https://i.ibb.co/7X6Bqs2/popular-resort-amara-dolce-vita-luxury-hotel-with-pools-water-parks-recreational-area-along-sea-coas.jpg')] bg-center bg-cover" >
                <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
                    <h1 className="text-5xl antialiased font-bold leading-none text-center text-blue-500 ">Subscribe Now</h1>
                    <p className="pt-2 pb-8 text-xl antialiased text-center text-blue-500">Find out about events and other news</p>
